...
Mantenimiento AC-016-08: `order.cancel` con `lines: []` cierra únicamente un pedido abierto sin líneas. Conserva motivo, revisión, actor, auditoría y reintentos; no genera cobro, devolución ni consumo. Una selección vacía sobre un pedido con productos sigue siendo inválida. Los schemas v2/v3 ya admiten el array vacío; no hay cambio de envoltura ni migración.
