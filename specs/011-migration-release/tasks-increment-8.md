...
| TASK-INC8-04 | Registrar cargas iniciales causales y progresivas por local | REQ-011-03; AC-011-02 | OPS-01 | Cantidades/costos revisados y movimientos independientes de historia | Habilitado: GO-02 validada con muestra representativa; carga completa no bloqueante |
...
| TASK-INC8-07 | Checklist operativo y arranque conjunto | REQ-011-05; AC-011-05 | TASK-INC8-03 a 06, OPS-05 | Autorización y validación posterior por ambos locales | Bloqueado por las puertas operativas restantes; DEC-009/GO-03 no aplican |
| TASK-INC8-08 | Preparar y verificar despliegue Railway | REQ-011-06; AC-011-08 | Proveedor Railway elegido; servicio web y PostgreSQL | Build, migración, `/health`, HTTPS y ausencia de secretos/datos locales en el artefacto | Completada el 18-09-2026; evidencia en `docs/evidence/railway-deployment-2026-09-18.md` |
