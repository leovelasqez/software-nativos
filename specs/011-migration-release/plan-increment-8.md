...
| OPS-01 | Conteo físico y costos revisados por bodega/local en la fecha de corte | Operación local; DEC-005 no permite inferir costos |
| OPS-02 | Decisión fiscal aprobada antes de reemplazar Alegra | DEC-009 |
...
| OPS-04 | Política externa de respaldo: ubicación, retención, presupuesto, RPO y RTO | DEC-012 |
...
6. Registrar el conteo físico como movimientos iniciales causales independientes de la historia. No usar ventas históricas para reconstruir existencias o costos.
...
- El lanzamiento, la fiscalidad, el adaptador WhatsApp y la retención externa permanecen fuera de este plan hasta contar con autorizaciones y datos explícitos.

## Evidencia de salida

`docs/evidence/increment-8.md` debe conservar: manifiestos/hash de fuentes (sin secretos ni datos personales), mapeo y rechazos, resumen de cada conciliación, fecha de corte, conteos físicos aprobados, resultados de impresión/cajón por local, restauración aislada, responsables y autorización de lanzamiento. No incluir volcados comerciales, contraseñas, teléfonos ni credenciales.
