...
Ampliación del 25-09-2026, opción 1 del usuario: continuar el mismo turno desde otro navegador con el mismo responsable (AC-018-05/06/07). Proyección del libro central sin duplicar ni sobrescribir pendientes; cierre compartido online. Las mismas pruebas cubren migración, permisos, reintentos, ventas offline y convergencia entre dos contextos reales.
