...
| DEC-009 | Transición aprobada, validación externa pendiente | Durante el piloto la emisión fiscal permanece en Alegra y se concilia contra los comprobantes internos. El contador aún debe confirmar documentos, tasas, numeración, fecha de fin y procedimiento de contingencia. | Puesta en marcha real. |
...
| DEC-012 | Servicio administrado con PITR elegido; parámetros pendientes | El usuario eligió respaldo administrado con recuperación a punto en el tiempo. Alojamiento y despliegue se difieren. Antes de publicar faltan proveedor, presupuesto, responsable, RPO, RTO y retención explícitos; ninguna copia central cubre pendientes exclusivos de IndexedDB. | Operación antes de publicar. |
